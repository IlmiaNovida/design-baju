...
<head>
    ...
    <link rel="manifest" herf="{{ asset('/manifest.json') }}">
...
<body>
    ...
    <section id="hero" class="d-flex flex-column justify-content-center">
        <div class="container" data-aos="zoom-in" data-aos-delay="100">
            ...
            <p>Web Desain <span class="typed" data-typed-items="Kaos Polos, Polo, Sweatshirt, Hoodie, Boomber, Jaket"></span></p>
        ...
        <section id="portfolio" class="portfolio section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset ('img/background_tshirt.png') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <h4>Card 3</h4>
                                <p>Card</p>
                                <div class="portfolio-links">
                                    <a href="{{ asset ('img/background_tshirt.png') }}"
                                        data-gallery="portfolioGallery" class="portfolio-lightbox" title="Card 3"><i
                                            class="bx bx-plus"></i></a>
                                    <a href="portfolio-details.html" class="portfolio-details-lightbox"
                                        data-glightbox="type: external" title="Portfolio Details"><i
                                            class="bx bx-link"></i></a>
                                    <a href="#edit"> <i class="bx bx-edit"
                                            onclick="gantiBG('{{ asset ('img/background_tshirt.png') }}')"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section id="edit" style="background: #FFF;">
        <div class="" data-aos="zoom-in" data-aos-delay="350">
            ...
            <center>
                ...
                <div class="col-12">
                    <div class="col-6">
                        <label for="tshirt-color">Warna:</label>
